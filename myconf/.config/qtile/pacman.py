...
class Pacman(base.ThreadedPollText):
    ...
    defaults = [
        ...
        ('notifyPacman', 'notify-send "$(/usr/bin/pacman -Qu \
            --dbpath /tmp/checkup-db-$USER/)"', 'notify update file.'),
    ]
    ...
    def button_press(self, x, y, button):
        ...
        elif button == 3 and self.notifyPacman is not None:
            subprocess.Popen([self.notifyPacman], shell=True)
